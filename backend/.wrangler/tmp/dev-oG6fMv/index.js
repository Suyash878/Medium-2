...
// .wrangler/tmp/bundle-5qS6MI/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/suyash/Desktop/Medium/project_medium/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/suyash/Desktop/Medium/project_medium/backend/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null
      },
...
// node_modules/@suyash_dev/medium-package-first/dist/index.js
var require_dist = __commonJS({
  "node_modules/@suyash_dev/medium-package-first/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-5qS6MI/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-5qS6MI/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_medium_package_first = __toESM(require_dist());
var userRouter = new Hono2();
userRouter.post("/signup", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_package_first.signupInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
...
userRouter.post("/signin", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_package_first.signinInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
...
var prisma = new import_edge2.PrismaClient();
...
blogRouter.post("/", async (c) => {
  ...
  const blog = await prisma2.post.create({
    data: {
      title: body.title,
...
blogRouter.put("/:id", async (c) => {
  ...
  const blog = await prisma2.post.update({
    where: {
      id
    },
    data: {
...
blogRouter.get("/bulk", async (c) => {
  ...
  const blogs = await prisma2.post.findMany();
  try {
    return c.json(blogs);
  } catch (err) {
    c.status(411);
...
blogRouter.get("/:id", async (c) => {
  ...
  try {
    const blog = await prisma2.post.findFirst({
      where: {
        id
      }
    });
